...
func TestSetRootPassword(t *testing.T) {
	...
	require.Equal(t, rpcmessages.ErrorSetRootPasswordToShort, responseInvalid.Code)
	...
	require.Equal(t, rpcmessages.ErrorSetRootPasswordToShort, responseUnicode7.Code)
...
func TestGetHostname(t *testing.T) {
	...
	require.Equal(t, rpcmessages.ErrorUnhandled, response.ErrorResponse.Code)
